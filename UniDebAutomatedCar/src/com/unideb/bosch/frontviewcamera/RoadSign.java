...
/**
 * @author Nandi This class makes it possible to compare RoadSign objects by distance and then we can simply arrange them in a list to get to 5 closest road sign with it's signal.
 *
 */
