...
public class RSensorSignalSender {
	...
	public static void send_Radar_Sensor_Signals(RSensor radar) {
		...
		for (int i = 0; i < objectList.size(); i++) {
			...
			VirtualFunctionBus.sendSignal(new Signal(SignalDatabase.LONGITUDINAL_RELATIVE_VELOCITY, (int) actRadarObject.longitudinalRelative_Velcit));
			...
			VirtualFunctionBus.sendSignal(new Signal(SignalDatabase.LATERAL_RELATIVE_VELOCITY, (int) actRadarObject.longitudinalRelative_Velcit));
